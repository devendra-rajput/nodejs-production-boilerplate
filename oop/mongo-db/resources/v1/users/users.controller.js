 ...
 * Handles user-related operations and request processing
 */
  ...
  */
  ...
  deleteImage = async (req, res) => {
    ...
    try {
      ...
      console.error('UsersController@deleteImage Error:', err.message);
  ...
  generatePresignedUrl = async (req, res) => {
    ...
    try {
      ...
      console.error('UsersController@generatePresignedUrl Error:', error.message);
      return response.exception('error.serverError', res, null);
    }
  };
}
