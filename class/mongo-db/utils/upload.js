...
class Upload {
  ...
  createStorage = (directoryPath = 'uploads/default') => multer.diskStorage({
  ...
  /**
     ...
     * @returns
     */
  uploadFile = (type = /jpg|jpeg|png|heic/, fileSize = 5 * 1024 * 1024, directoryPath = 'uploads/default') => this.fileUploader(type, fileSize, directoryPath);
