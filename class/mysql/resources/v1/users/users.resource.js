 ...
 * - Dependency Injection: Injects User model and Redis cache
...
class UserResource extends BaseResource {
   ...
   * @param {number|boolean} userId - User ID to exclude
  ...
  /**
   * Get all users with pagination (with caching)
  ...
  async getAllWithPagination(page, limit, filterObj = {}) {
    ...
    try {
      ...
      return await this._getCachedOrExecute(cacheKey, async () => {
        ...
        return await super.getAllWithPagination(page, limit, filterObj, options);
      });
    } catch (error) {
