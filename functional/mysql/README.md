# Scalable Node.js, Express & MySQL Starter Kit (Functional Architecture)
...
│   ├── modelManager.js     # Database model management
...
├── models/                 # Sequelize models (centralized)
...
cd nodejs-production-boilerplate/functional/mysql
```
