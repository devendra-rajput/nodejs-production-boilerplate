# Scalable Node.js, Express & MongoDB Starter Kit (OOP Principles)
...
*A professional-grade Node.js boilerplate built with **Object-Oriented Programming** principles and MongoDB database for building secure, scalable, and maintainable backend applications.*
...
cd nodejs-production-boilerplate/oop/mongo-db
```
...
const users = await UserModel.getAllWithPagination(1, 10);
...
**Built with Node.js | Powered by OOP & MongoDB | Designed for Production**
