...
/**
 * MultiIPRateLimiterTester - Tests rate limiting across multiple IPs
 */
class MultiIPRateLimiterTester {
  ...
  /**
   * Generate fake IP address for user
   */
  ...
  /**
   * Make request spoofing a specific IP
   */
