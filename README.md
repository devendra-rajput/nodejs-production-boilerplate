...
Testing support (Jest / Supertest) can be added.  
Contributions for test coverage are welcome.

### Included Load Tests (MySQL Version)
- **Rate Limiter Test**: `node tests/test-rate-limiter.js`
- **Multi-IP Rate Limiter Test**: `node tests/test-multi-ip.js`
