 ...
 * - Encapsulation: All startup logic in one class
 * - Single Responsibility: Only handles app initialization
 * - Organization: Logical grouping of setup methods
 */
class ApplicationBootstrap {
  ...
  async _initializeModels() {
    console.log('🗄️  Initializing models and syncing database...');
  ...
  async initialize() {
    ...
    try {
      ...
      // Step 3: Initialize models and sync database
