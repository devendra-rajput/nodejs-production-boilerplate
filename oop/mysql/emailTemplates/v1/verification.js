               ...
               <tr>
                  <td>
                     <table cellpadding="0" width="600" class="container" align="center" cellspacing="0" border="0" >
                        ...
                        <tr height="40">
                           <td>
                              <p style="font-family: 'Montserrat', sans-serif; font-weight: bold; color: #000; font-size: 20px; text-align: center;">Verification</p>
                           </td>
                        </tr>
                        <tr>
                           <td>
                              ...
                              <p style="font-family: 'Montserrat', sans-serif;color: #707070;text-align: left;padding: 0px 20px;font-size: 14px;line-height: 22px;">To finalize the account we need to verify your email address. Please enter the following code on the app signup screen to complete the process. 
                           </td>
                        </tr>
                        <tr>
