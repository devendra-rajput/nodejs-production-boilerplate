 ...
 *
 * Handles automatic route discovery and registration
 * Follows OOP principles:
 * - Encapsulation: Route loading logic in one class
 * - Single Responsibility: Only handles route registration
 * - Clean Code: Organized methods
 */
class RouteLoader {
  constructor(app) {
    this.app = app;
